...
--   • event_types (5 rows), event_sources (3 rows)
--   • districts (4 rows — Vancouver/2010, Vancouver-Minimal/2010-M,
--                         Cascade Disposal/2012, Houston/5120)
--   • service_codes (3 codes × 2 districts)
--   • route_events (14 events × 2 districts + 11 duplicate-cluster events)
--   • event_actions (notes, close, charge, and history entries)
--
...
IF NOT EXISTS (SELECT 1 FROM dbo.event_types WHERE id = 1)
    INSERT INTO dbo.event_types (id, name, active) VALUES (1, N'Extra',             1);
IF NOT EXISTS (SELECT 1 FROM dbo.event_types WHERE id = 2)
    INSERT INTO dbo.event_types (id, name, active) VALUES (2, N'Contamination',     1);
IF NOT EXISTS (SELECT 1 FROM dbo.event_types WHERE id = 3)
    INSERT INTO dbo.event_types (id, name, active) VALUES (3, N'Overloaded',        1);
IF NOT EXISTS (SELECT 1 FROM dbo.event_types WHERE id = 4)
    INSERT INTO dbo.event_types (id, name, active) VALUES (4, N'Blocked Container', 1);
IF NOT EXISTS (SELECT 1 FROM dbo.event_types WHERE id = 5)
    INSERT INTO dbo.event_types (id, name, active) VALUES (5, N'Not Out',           1);

SET IDENTITY_INSERT dbo.event_types OFF;
GO

-- ---- event_sources (IDs 1-3) --------------------------------
SET IDENTITY_INSERT dbo.event_sources ON;

IF NOT EXISTS (SELECT 1 FROM dbo.event_sources WHERE id = 1)
    INSERT INTO dbo.event_sources (id, name, active) VALUES (1, N'WasteVision', 1);
IF NOT EXISTS (SELECT 1 FROM dbo.event_sources WHERE id = 2)
    INSERT INTO dbo.event_sources (id, name, active) VALUES (2, N'3rd Eye',     1);
IF NOT EXISTS (SELECT 1 FROM dbo.event_sources WHERE id = 3)
    INSERT INTO dbo.event_sources (id, name, active) VALUES (3, N'Manual',      1);

SET IDENTITY_INSERT dbo.event_sources OFF;
GO
...
IF NOT EXISTS (SELECT 1 FROM dbo.districts WHERE id = 1)
    INSERT INTO dbo.districts (id, number, name, region, hauling_system, active)
...
-- District 1 (2010)
IF NOT EXISTS (SELECT 1 FROM dbo.service_codes WHERE district_id = 1 AND code = N'EXTRA-COM')
    INSERT INTO dbo.service_codes (district_id, code, description, amount, active)
    VALUES (1, N'EXTRA-COM', N'Extra pickup - Commercial', 70.0000, 1);

IF NOT EXISTS (SELECT 1 FROM dbo.service_codes WHERE district_id = 1 AND code = N'CONTAM')
    INSERT INTO dbo.service_codes (district_id, code, description, amount, active)
    VALUES (1, N'CONTAM', N'Contamination charge', 90.0000, 1);

IF NOT EXISTS (SELECT 1 FROM dbo.service_codes WHERE district_id = 1 AND code = N'OVERLOAD')
    INSERT INTO dbo.service_codes (district_id, code, description, amount, active)
    VALUES (1, N'OVERLOAD', N'Overloaded container charge', 60.0000, 1);

-- District 2 (2010-M)
IF NOT EXISTS (SELECT 1 FROM dbo.service_codes WHERE district_id = 2 AND code = N'EXTRA-COM')
    INSERT INTO dbo.service_codes (district_id, code, description, amount, active)
    VALUES (2, N'EXTRA-COM', N'Extra pickup - Commercial', 70.0000, 1);

IF NOT EXISTS (SELECT 1 FROM dbo.service_codes WHERE district_id = 2 AND code = N'CONTAM')
    INSERT INTO dbo.service_codes (district_id, code, description, amount, active)
    VALUES (2, N'CONTAM', N'Contamination charge', 90.0000, 1);

IF NOT EXISTS (SELECT 1 FROM dbo.service_codes WHERE district_id = 2 AND code = N'OVERLOAD')
    INSERT INTO dbo.service_codes (district_id, code, description, amount, active)
    VALUES (2, N'OVERLOAD', N'Overloaded container charge', 60.0000, 1);
GO

-- ============================================================
-- SECTION 4 — route_events: district 2010 (id=1)
--
-- External-id format: [seed:district-demo]-2010-{key}
-- Account format:     2010-{suffix}
-- date_occurred:      DATEADD(minute, -minsAgo, GETUTCDATE())
-- date_closed:        date_occurred + 45 min  (closed/charged only)
-- customer_since:     DATEADD(month, -N, GETUTCDATE())
-- ============================================================

-- [c1-wv] Overloaded · WasteVision · open  (minsAgo=132)
IF NOT EXISTS (SELECT 1 FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-c1-wv')
...
IF NOT EXISTS (SELECT 1 FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-c1-3e')
    INSERT INTO dbo.route_events (
        district_id, event_type_id, event_source_id, external_id,
        date_occurred, vehicle, route, latitude, longitude, address,
        customer_name, account_number, bill_area, bin_serial_number,
...
IF NOT EXISTS (SELECT 1 FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-c2-wv')
    INSERT INTO dbo.route_events (
        district_id, event_type_id, event_source_id, external_id,
        date_occurred, vehicle, route, latitude, longitude, address,
        customer_name, account_number, bill_area, bin_serial_number,
...
IF NOT EXISTS (SELECT 1 FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-c2-3e')
    INSERT INTO dbo.route_events (
        district_id, event_type_id, event_source_id, external_id,
        date_occurred, vehicle, route, latitude, longitude, address,
        customer_name, account_number, bill_area, bin_serial_number,
...
IF NOT EXISTS (SELECT 1 FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-c3-wv')
    INSERT INTO dbo.route_events (
        district_id, event_type_id, event_source_id, external_id,
        date_occurred, vehicle, route, latitude, longitude, address,
        customer_name, account_number, bill_area, bin_serial_number,
...
IF NOT EXISTS (SELECT 1 FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-c3-3e')
    INSERT INTO dbo.route_events (
        district_id, event_type_id, event_source_id, external_id,
        date_occurred, vehicle, route, latitude, longitude, address,
        customer_name, account_number, bill_area, bin_serial_number,
...
IF NOT EXISTS (SELECT 1 FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-s1')
    INSERT INTO dbo.route_events (
        district_id, event_type_id, event_source_id, external_id,
        date_occurred, vehicle, route, latitude, longitude, address,
        customer_name, account_number, bill_area, bin_serial_number,
...
IF NOT EXISTS (SELECT 1 FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-s2')
    INSERT INTO dbo.route_events (
        district_id, event_type_id, event_source_id, external_id,
        date_occurred, vehicle, route, latitude, longitude, address,
        customer_name, account_number, bill_area, bin_serial_number,
...
IF NOT EXISTS (SELECT 1 FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-s3')
    INSERT INTO dbo.route_events (
        district_id, event_type_id, event_source_id, external_id,
        date_occurred, vehicle, route, latitude, longitude, address,
        customer_name, account_number, bill_area, bin_serial_number,
...
IF NOT EXISTS (SELECT 1 FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-s4')
    INSERT INTO dbo.route_events (
        district_id, event_type_id, event_source_id, external_id,
        date_occurred, vehicle, route, latitude, longitude, address,
        customer_name, account_number, bill_area, bin_serial_number,
...
IF NOT EXISTS (SELECT 1 FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-s5')
    INSERT INTO dbo.route_events (
        district_id, event_type_id, event_source_id, external_id,
        date_occurred, vehicle, route, latitude, longitude, address,
        customer_name, account_number, bill_area, bin_serial_number,
...
IF NOT EXISTS (SELECT 1 FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-s6')
    INSERT INTO dbo.route_events (
        district_id, event_type_id, event_source_id, external_id,
        date_occurred, vehicle, route, latitude, longitude, address,
        customer_name, account_number, bill_area, bin_serial_number,
...
IF NOT EXISTS (SELECT 1 FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-s7')
    INSERT INTO dbo.route_events (
        district_id, event_type_id, event_source_id, external_id,
        date_occurred, vehicle, route, latitude, longitude, address,
        customer_name, account_number, bill_area, bin_serial_number,
...
IF NOT EXISTS (SELECT 1 FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-s8')
    INSERT INTO dbo.route_events (
        district_id, event_type_id, event_source_id, external_id,
        date_occurred, vehicle, route, latitude, longitude, address,
        customer_name, account_number, bill_area, bin_serial_number,
...
-- ============================================================
-- SECTION 5 — route_events: district 2010-M (id=2)
--
...
IF NOT EXISTS (SELECT 1 FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-M-c1-wv')
    INSERT INTO dbo.route_events (
        district_id, event_type_id, event_source_id, external_id,
        date_occurred, vehicle, route, latitude, longitude, address,
        customer_name, account_number, bill_area, bin_serial_number,
...
IF NOT EXISTS (SELECT 1 FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-M-c1-3e')
    INSERT INTO dbo.route_events (
        district_id, event_type_id, event_source_id, external_id,
        date_occurred, vehicle, route, latitude, longitude, address,
        customer_name, account_number, bill_area, bin_serial_number,
...
IF NOT EXISTS (SELECT 1 FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-M-c2-wv')
    INSERT INTO dbo.route_events (
        district_id, event_type_id, event_source_id, external_id,
        date_occurred, vehicle, route, latitude, longitude, address,
        customer_name, account_number, bill_area, bin_serial_number,
...
IF NOT EXISTS (SELECT 1 FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-M-c2-3e')
    INSERT INTO dbo.route_events (
        district_id, event_type_id, event_source_id, external_id,
        date_occurred, vehicle, route, latitude, longitude, address,
        customer_name, account_number, bill_area, bin_serial_number,
...
IF NOT EXISTS (SELECT 1 FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-M-c3-wv')
    INSERT INTO dbo.route_events (
        district_id, event_type_id, event_source_id, external_id,
        date_occurred, vehicle, route, latitude, longitude, address,
        customer_name, account_number, bill_area, bin_serial_number,
...
IF NOT EXISTS (SELECT 1 FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-M-c3-3e')
    INSERT INTO dbo.route_events (
        district_id, event_type_id, event_source_id, external_id,
        date_occurred, vehicle, route, latitude, longitude, address,
        customer_name, account_number, bill_area, bin_serial_number,
...
IF NOT EXISTS (SELECT 1 FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-M-s1')
    INSERT INTO dbo.route_events (
        district_id, event_type_id, event_source_id, external_id,
        date_occurred, vehicle, route, latitude, longitude, address,
        customer_name, account_number, bill_area, bin_serial_number,
...
IF NOT EXISTS (SELECT 1 FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-M-s2')
    INSERT INTO dbo.route_events (
        district_id, event_type_id, event_source_id, external_id,
        date_occurred, vehicle, route, latitude, longitude, address,
        customer_name, account_number, bill_area, bin_serial_number,
...
IF NOT EXISTS (SELECT 1 FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-M-s3')
    INSERT INTO dbo.route_events (
        district_id, event_type_id, event_source_id, external_id,
        date_occurred, vehicle, route, latitude, longitude, address,
        customer_name, account_number, bill_area, bin_serial_number,
...
IF NOT EXISTS (SELECT 1 FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-M-s4')
    INSERT INTO dbo.route_events (
        district_id, event_type_id, event_source_id, external_id,
        date_occurred, vehicle, route, latitude, longitude, address,
        customer_name, account_number, bill_area, bin_serial_number,
...
IF NOT EXISTS (SELECT 1 FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-M-s5')
    INSERT INTO dbo.route_events (
        district_id, event_type_id, event_source_id, external_id,
        date_occurred, vehicle, route, latitude, longitude, address,
        customer_name, account_number, bill_area, bin_serial_number,
...
IF NOT EXISTS (SELECT 1 FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-M-s6')
    INSERT INTO dbo.route_events (
        district_id, event_type_id, event_source_id, external_id,
        date_occurred, vehicle, route, latitude, longitude, address,
        customer_name, account_number, bill_area, bin_serial_number,
...
IF NOT EXISTS (SELECT 1 FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-M-s7')
    INSERT INTO dbo.route_events (
        district_id, event_type_id, event_source_id, external_id,
        date_occurred, vehicle, route, latitude, longitude, address,
        customer_name, account_number, bill_area, bin_serial_number,
...
IF NOT EXISTS (SELECT 1 FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-M-s8')
    INSERT INTO dbo.route_events (
        district_id, event_type_id, event_source_id, external_id,
        date_occurred, vehicle, route, latitude, longitude, address,
        customer_name, account_number, bill_area, bin_serial_number,
...
-- ============================================================
-- SECTION 6 — route_events: duplicate clusters
--
...
IF NOT EXISTS (SELECT 1 FROM dbo.route_events WHERE external_id = N'DUPSEED-2010-A1')
    INSERT INTO dbo.route_events (
        district_id, event_type_id, event_source_id, external_id,
        date_occurred, vehicle, route, latitude, longitude, address,
        customer_name, account_number, quantity, image_url, image_urls,
        severity, event_status, date_closed, closed_by, customer_routes
    ) VALUES (
...
IF NOT EXISTS (SELECT 1 FROM dbo.route_events WHERE external_id = N'DUPSEED-2010-A2')
    INSERT INTO dbo.route_events (
        district_id, event_type_id, event_source_id, external_id,
        date_occurred, vehicle, route, latitude, longitude, address,
        customer_name, account_number, quantity, image_url, image_urls,
...
IF NOT EXISTS (SELECT 1 FROM dbo.route_events WHERE external_id = N'DUPSEED-2010-B1')
    INSERT INTO dbo.route_events (
        district_id, event_type_id, event_source_id, external_id,
        date_occurred, vehicle, route, latitude, longitude, address,
        customer_name, account_number, quantity, image_url, image_urls,
...
IF NOT EXISTS (SELECT 1 FROM dbo.route_events WHERE external_id = N'DUPSEED-2010-B2')
    INSERT INTO dbo.route_events (
        district_id, event_type_id, event_source_id, external_id,
        date_occurred, vehicle, route, latitude, longitude, address,
        customer_name, account_number, quantity, image_url, image_urls,
...
IF NOT EXISTS (SELECT 1 FROM dbo.route_events WHERE external_id = N'DUPSEED-2012-A1')
    INSERT INTO dbo.route_events (
        district_id, event_type_id, event_source_id, external_id,
        date_occurred, vehicle, route, latitude, longitude, address,
        customer_name, account_number, quantity, image_url, image_urls,
...
IF NOT EXISTS (SELECT 1 FROM dbo.route_events WHERE external_id = N'DUPSEED-2012-A2')
    INSERT INTO dbo.route_events (
        district_id, event_type_id, event_source_id, external_id,
        date_occurred, vehicle, route, latitude, longitude, address,
        customer_name, account_number, quantity, image_url, image_urls,
...
IF NOT EXISTS (SELECT 1 FROM dbo.route_events WHERE external_id = N'DUPSEED-5120-A1')
    INSERT INTO dbo.route_events (
        district_id, event_type_id, event_source_id, external_id,
        date_occurred, vehicle, route, latitude, longitude, address,
        customer_name, account_number, quantity, image_url, image_urls,
...
IF NOT EXISTS (SELECT 1 FROM dbo.route_events WHERE external_id = N'DUPSEED-5120-A2')
    INSERT INTO dbo.route_events (
        district_id, event_type_id, event_source_id, external_id,
        date_occurred, vehicle, route, latitude, longitude, address,
        customer_name, account_number, quantity, image_url, image_urls,
...
IF NOT EXISTS (SELECT 1 FROM dbo.route_events WHERE external_id = N'DUPSEED-5120-A3')
    INSERT INTO dbo.route_events (
        district_id, event_type_id, event_source_id, external_id,
        date_occurred, vehicle, route, latitude, longitude, address,
        customer_name, account_number, quantity, image_url, image_urls,
...
IF NOT EXISTS (SELECT 1 FROM dbo.route_events WHERE external_id = N'DUPSEED-5120-B1')
    INSERT INTO dbo.route_events (
        district_id, event_type_id, event_source_id, external_id,
        date_occurred, vehicle, route, latitude, longitude, address,
        customer_name, account_number, quantity, image_url, image_urls,
...
IF NOT EXISTS (SELECT 1 FROM dbo.route_events WHERE external_id = N'DUPSEED-5120-B2')
    INSERT INTO dbo.route_events (
        district_id, event_type_id, event_source_id, external_id,
        date_occurred, vehicle, route, latitude, longitude, address,
        customer_name, account_number, quantity, image_url, image_urls,
...
-- ============================================================
-- SECTION 7 — event_actions
--
-- One helper pattern per event that has actions.  Every block
-- checks for the target event_actions row before inserting.
--
-- note  action: dateCreated = date_occurred + 20 min
-- close action: dateCreated = date_closed   (date_occurred + 45 min)
...
IF NOT EXISTS (
    ...
    WHERE re.external_id = N'[seed:district-demo]-2010-c1-wv'
      AND ea.billed_statement_number = N'[seed:district-demo]-history'
)
BEGIN
    INSERT INTO dbo.event_actions (route_event_id, action_type, is_final, charge_amount, charge_quantity, payment_status, notes, billed_statement_number, created_by, date_created)
    SELECT id, N'charge', 0, 60.0000, 1.00, N'PAID',     N'Overage charge applied to account.', N'[seed:district-demo]-history', N'Kyle.Patrick', DATEADD(hour, 3, DATEADD(day, -12, GETUTCDATE())) FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-c1-wv';
    INSERT INTO dbo.event_actions (route_event_id, action_type, is_final, charge_amount, charge_quantity, payment_status, notes, billed_statement_number, created_by, date_created)
    SELECT id, N'charge', 0, 60.0000, 1.00, N'PAID',     N'Overage charge applied to account.', N'[seed:district-demo]-history', N'Kyle.Patrick', DATEADD(hour, 3, DATEADD(day, -41, GETUTCDATE())) FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-c1-wv';
    INSERT INTO dbo.event_actions (route_event_id, action_type, is_final, charge_amount, charge_quantity, payment_status, notes, billed_statement_number, created_by, date_created)
    SELECT id, N'charge', 0, 70.0000, 1.00, N'REFUNDED', N'Overage charge applied to account.', N'[seed:district-demo]-history', N'Kyle.Patrick', DATEADD(hour, 3, DATEADD(day, -77, GETUTCDATE())) FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-c1-wv';
END

IF NOT EXISTS (
    SELECT 1 FROM dbo.event_actions ea
    INNER JOIN dbo.route_events re ON ea.route_event_id = re.id
    WHERE re.external_id = N'[seed:district-demo]-2010-M-c1-wv'
      AND ea.billed_statement_number = N'[seed:district-demo]-history'
)
BEGIN
    INSERT INTO dbo.event_actions (route_event_id, action_type, is_final, charge_amount, charge_quantity, payment_status, notes, billed_statement_number, created_by, date_created)
    SELECT id, N'charge', 0, 60.0000, 1.00, N'PAID',     N'Overage charge applied to account.', N'[seed:district-demo]-history', N'Kyle.Patrick', DATEADD(hour, 3, DATEADD(day, -12, GETUTCDATE())) FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-M-c1-wv';
    INSERT INTO dbo.event_actions (route_event_id, action_type, is_final, charge_amount, charge_quantity, payment_status, notes, billed_statement_number, created_by, date_created)
    SELECT id, N'charge', 0, 60.0000, 1.00, N'PAID',     N'Overage charge applied to account.', N'[seed:district-demo]-history', N'Kyle.Patrick', DATEADD(hour, 3, DATEADD(day, -41, GETUTCDATE())) FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-M-c1-wv';
    INSERT INTO dbo.event_actions (route_event_id, action_type, is_final, charge_amount, charge_quantity, payment_status, notes, billed_statement_number, created_by, date_created)
    SELECT id, N'charge', 0, 70.0000, 1.00, N'REFUNDED', N'Overage charge applied to account.', N'[seed:district-demo]-history', N'Kyle.Patrick', DATEADD(hour, 3, DATEADD(day, -77, GETUTCDATE())) FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-M-c1-wv';
END
GO
...
IF NOT EXISTS (
    SELECT 1 FROM dbo.event_actions ea
    INNER JOIN dbo.route_events re ON ea.route_event_id = re.id
    WHERE re.external_id = N'[seed:district-demo]-2010-c2-wv'
      AND ea.action_type = N'note'
)
    INSERT INTO dbo.event_actions (route_event_id, action_type, is_final, notes, billed_statement_number, created_by, date_created)
    ...
    FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-c2-wv';
...
IF NOT EXISTS (
    ...
    INSERT INTO dbo.event_actions (route_event_id, action_type, is_final, service_code_id, charge_amount, charge_quantity, payment_status, notes, billed_statement_number, created_by, date_created)
    SELECT re.id, N'charge', 1,
           (SELECT id FROM dbo.service_codes WHERE district_id = 1 AND code = N'EXTRA-COM'),
           70.0000, 2.00, N'PAID', N'Overage charge applied to account.',
           N'[seed:district-demo]', N'Kyle.Patrick', DATEADD(minute, -380, GETUTCDATE())
    FROM dbo.route_events re WHERE external_id = N'[seed:district-demo]-2010-c2-wv';
...
BEGIN
    INSERT INTO dbo.event_actions (route_event_id, action_type, is_final, charge_amount, charge_quantity, payment_status, notes, billed_statement_number, created_by, date_created)
    SELECT id, N'charge', 0, 70.0000, 1.00, N'PAID', N'Overage charge applied to account.', N'[seed:district-demo]-history', N'Kyle.Patrick', DATEADD(hour, 3, DATEADD(day, -25, GETUTCDATE())) FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-c2-wv';
    INSERT INTO dbo.event_actions (route_event_id, action_type, is_final, charge_amount, charge_quantity, payment_status, notes, billed_statement_number, created_by, date_created)
    SELECT id, N'charge', 0, 70.0000, 1.00, N'PAID', N'Overage charge applied to account.', N'[seed:district-demo]-history', N'Kyle.Patrick', DATEADD(hour, 3, DATEADD(day, -58, GETUTCDATE())) FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-c2-wv';
END
...
IF NOT EXISTS (
    SELECT 1 FROM dbo.event_actions ea
    INNER JOIN dbo.route_events re ON ea.route_event_id = re.id
    WHERE re.external_id = N'[seed:district-demo]-2010-M-c2-wv'
      AND ea.action_type = N'note'
)
    INSERT INTO dbo.event_actions (route_event_id, action_type, is_final, notes, billed_statement_number, created_by, date_created)
    SELECT id, N'note', 0, N'Customer called ahead about extra bags; charge approved by CSR.',
           N'[seed:district-demo]', N'Kyle.Patrick', DATEADD(minute, -405, GETUTCDATE())
    FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-M-c2-wv';
...
IF NOT EXISTS (
    ...
    INSERT INTO dbo.event_actions (route_event_id, action_type, is_final, service_code_id, charge_amount, charge_quantity, payment_status, notes, billed_statement_number, created_by, date_created)
    SELECT re.id, N'charge', 1,
           (SELECT id FROM dbo.service_codes WHERE district_id = 2 AND code = N'EXTRA-COM'),
           70.0000, 2.00, N'PAID', N'Overage charge applied to account.',
           N'[seed:district-demo]', N'Kyle.Patrick', DATEADD(minute, -380, GETUTCDATE())
    FROM dbo.route_events re WHERE external_id = N'[seed:district-demo]-2010-M-c2-wv';
...
BEGIN
    INSERT INTO dbo.event_actions (route_event_id, action_type, is_final, charge_amount, charge_quantity, payment_status, notes, billed_statement_number, created_by, date_created)
    SELECT id, N'charge', 0, 70.0000, 1.00, N'PAID', N'Overage charge applied to account.', N'[seed:district-demo]-history', N'Kyle.Patrick', DATEADD(hour, 3, DATEADD(day, -25, GETUTCDATE())) FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-M-c2-wv';
    INSERT INTO dbo.event_actions (route_event_id, action_type, is_final, charge_amount, charge_quantity, payment_status, notes, billed_statement_number, created_by, date_created)
    SELECT id, N'charge', 0, 70.0000, 1.00, N'PAID', N'Overage charge applied to account.', N'[seed:district-demo]-history', N'Kyle.Patrick', DATEADD(hour, 3, DATEADD(day, -58, GETUTCDATE())) FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-M-c2-wv';
END
GO
...
IF NOT EXISTS (
    SELECT 1 FROM dbo.event_actions ea
    INNER JOIN dbo.route_events re ON ea.route_event_id = re.id
    WHERE re.external_id = N'[seed:district-demo]-2010-c2-3e'
      AND ea.action_type = N'note'
)
    INSERT INTO dbo.event_actions (route_event_id, action_type, is_final, notes, billed_statement_number, created_by, date_created)
    ...
    FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-c2-3e';
...
IF NOT EXISTS (
    ...
    INSERT INTO dbo.event_actions (route_event_id, action_type, is_final, close_reason, billed_statement_number, created_by, date_created)
...
IF NOT EXISTS (
    SELECT 1 FROM dbo.event_actions ea
    INNER JOIN dbo.route_events re ON ea.route_event_id = re.id
    WHERE re.external_id = N'[seed:district-demo]-2010-M-c2-3e'
      AND ea.action_type = N'note'
)
    INSERT INTO dbo.event_actions (route_event_id, action_type, is_final, notes, billed_statement_number, created_by, date_created)
    SELECT id, N'note', 0, N'Duplicate of WasteVision report at same address; closing.',
           N'[seed:district-demo]', N'Kyle.Patrick', DATEADD(minute, -403, GETUTCDATE())
    FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-M-c2-3e';
...
IF NOT EXISTS (
    SELECT 1 FROM dbo.event_actions ea
    INNER JOIN dbo.route_events re ON ea.route_event_id = re.id
    WHERE re.external_id = N'[seed:district-demo]-2010-c3-wv'
      AND ea.billed_statement_number = N'[seed:district-demo]-history'
)
    INSERT INTO dbo.event_actions (route_event_id, action_type, is_final, charge_amount, charge_quantity, payment_status, notes, billed_statement_number, created_by, date_created)
    ...
    FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-c3-wv';

IF NOT EXISTS (
    SELECT 1 FROM dbo.event_actions ea
    INNER JOIN dbo.route_events re ON ea.route_event_id = re.id
    WHERE re.external_id = N'[seed:district-demo]-2010-M-c3-wv'
      AND ea.billed_statement_number = N'[seed:district-demo]-history'
)
    INSERT INTO dbo.event_actions (route_event_id, action_type, is_final, charge_amount, charge_quantity, payment_status, notes, billed_statement_number, created_by, date_created)
    SELECT id, N'charge', 0, 90.0000, 1.00, N'PAID', N'Overage charge applied to account.', N'[seed:district-demo]-history', N'Kyle.Patrick', DATEADD(hour, 3, DATEADD(day, -19, GETUTCDATE()))
    FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-M-c3-wv';
GO
...
IF NOT EXISTS (
    SELECT 1 FROM dbo.event_actions ea
    INNER JOIN dbo.route_events re ON ea.route_event_id = re.id
    WHERE re.external_id = N'[seed:district-demo]-2010-s1'
      AND ea.billed_statement_number = N'[seed:district-demo]-history'
)
    INSERT INTO dbo.event_actions (route_event_id, action_type, is_final, charge_amount, charge_quantity, payment_status, notes, billed_statement_number, created_by, date_created)
    ...
    FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-s1';

IF NOT EXISTS (
    SELECT 1 FROM dbo.event_actions ea
    INNER JOIN dbo.route_events re ON ea.route_event_id = re.id
    WHERE re.external_id = N'[seed:district-demo]-2010-M-s1'
      AND ea.billed_statement_number = N'[seed:district-demo]-history'
)
    INSERT INTO dbo.event_actions (route_event_id, action_type, is_final, charge_amount, charge_quantity, payment_status, notes, billed_statement_number, created_by, date_created)
    SELECT id, N'charge', 0, 15.0000, 1.00, N'PAID', N'Overage charge applied to account.', N'[seed:district-demo]-history', N'Kyle.Patrick', DATEADD(hour, 3, DATEADD(day, -33, GETUTCDATE()))
    FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-M-s1';
GO
...
IF NOT EXISTS (
    SELECT 1 FROM dbo.event_actions ea
    INNER JOIN dbo.route_events re ON ea.route_event_id = re.id
    WHERE re.external_id = N'[seed:district-demo]-2010-s2'
      AND ea.action_type = N'note'
)
    INSERT INTO dbo.event_actions (route_event_id, action_type, is_final, notes, billed_statement_number, created_by, date_created)
    ...
    FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-s2';
...
IF NOT EXISTS (
    SELECT 1 FROM dbo.event_actions ea
    INNER JOIN dbo.route_events re ON ea.route_event_id = re.id
    WHERE re.external_id = N'[seed:district-demo]-2010-M-s2'
      AND ea.action_type = N'note'
)
    INSERT INTO dbo.event_actions (route_event_id, action_type, is_final, notes, billed_statement_number, created_by, date_created)
    SELECT id, N'note', 0, N'Cart was out by the time the follow-up truck arrived.',
           N'[seed:district-demo]', N'Kyle.Patrick', DATEADD(minute, -2910, GETUTCDATE())
    FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-M-s2';
...
IF NOT EXISTS (
    SELECT 1 FROM dbo.event_actions ea
    INNER JOIN dbo.route_events re ON ea.route_event_id = re.id
    WHERE re.external_id = N'[seed:district-demo]-2010-s3'
      AND ea.action_type = N'note'
)
    INSERT INTO dbo.event_actions (route_event_id, action_type, is_final, notes, billed_statement_number, created_by, date_created)
    ...
    FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-s3';

IF NOT EXISTS (
    SELECT 1 FROM dbo.event_actions ea
    INNER JOIN dbo.route_events re ON ea.route_event_id = re.id
    WHERE re.external_id = N'[seed:district-demo]-2010-M-s3'
      AND ea.action_type = N'note'
)
    INSERT INTO dbo.event_actions (route_event_id, action_type, is_final, notes, billed_statement_number, created_by, date_created)
    SELECT id, N'note', 0, N'Driver reported extra pallets of boxed waste at loading dock.',
           N'[seed:district-demo]', N'Kyle.Patrick', DATEADD(minute, -75, GETUTCDATE())
    FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-M-s3';
GO
...
IF NOT EXISTS (
    SELECT 1 FROM dbo.event_actions ea
    INNER JOIN dbo.route_events re ON ea.route_event_id = re.id
    WHERE re.external_id = N'[seed:district-demo]-2010-s4'
      AND ea.action_type = N'note'
)
    INSERT INTO dbo.event_actions (route_event_id, action_type, is_final, notes, billed_statement_number, created_by, date_created)
    ...
    FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-s4';
...
IF NOT EXISTS (
    ...
    INSERT INTO dbo.event_actions (route_event_id, action_type, is_final, service_code_id, charge_amount, charge_quantity, payment_status, notes, billed_statement_number, created_by, date_created)
    SELECT re.id, N'charge', 1,
           (SELECT id FROM dbo.service_codes WHERE district_id = 1 AND code = N'OVERLOAD'),
    ...
    FROM dbo.route_events re WHERE external_id = N'[seed:district-demo]-2010-s4';
...
BEGIN
    INSERT INTO dbo.event_actions (route_event_id, action_type, is_final, charge_amount, charge_quantity, payment_status, notes, billed_statement_number, created_by, date_created)
    SELECT id, N'charge', 0, 60.0000, 1.00, N'PAID', N'Overage charge applied to account.', N'[seed:district-demo]-history', N'Kyle.Patrick', DATEADD(hour, 3, DATEADD(day, -14, GETUTCDATE())) FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-s4';
    INSERT INTO dbo.event_actions (route_event_id, action_type, is_final, charge_amount, charge_quantity, payment_status, notes, billed_statement_number, created_by, date_created)
    SELECT id, N'charge', 0, 60.0000, 1.00, NULL,     N'Overage charge applied to account.', N'[seed:district-demo]-history', N'Kyle.Patrick', DATEADD(hour, 3, DATEADD(day, -49, GETUTCDATE())) FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-s4';
    INSERT INTO dbo.event_actions (route_event_id, action_type, is_final, charge_amount, charge_quantity, payment_status, notes, billed_statement_number, created_by, date_created)
    SELECT id, N'charge', 0, 60.0000, 1.00, N'PAID', N'Overage charge applied to account.', N'[seed:district-demo]-history', N'Kyle.Patrick', DATEADD(hour, 3, DATEADD(day, -83, GETUTCDATE())) FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-s4';
END
...
IF NOT EXISTS (
    SELECT 1 FROM dbo.event_actions ea
    INNER JOIN dbo.route_events re ON ea.route_event_id = re.id
    WHERE re.external_id = N'[seed:district-demo]-2010-M-s4'
      AND ea.action_type = N'note'
)
    INSERT INTO dbo.event_actions (route_event_id, action_type, is_final, notes, billed_statement_number, created_by, date_created)
    SELECT id, N'note', 0, N'Lid open >45 degrees, photos confirm overload.',
           N'[seed:district-demo]', N'Kyle.Patrick', DATEADD(minute, -1720, GETUTCDATE())
    FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-M-s4';
...
IF NOT EXISTS (
    ...
    INSERT INTO dbo.event_actions (route_event_id, action_type, is_final, service_code_id, charge_amount, charge_quantity, payment_status, notes, billed_statement_number, created_by, date_created)
    SELECT re.id, N'charge', 1,
           (SELECT id FROM dbo.service_codes WHERE district_id = 2 AND code = N'OVERLOAD'),
           60.0000, 1.00, N'PAID', N'Overage charge applied to account.',
           N'[seed:district-demo]', N'Kyle.Patrick', DATEADD(minute, -1695, GETUTCDATE())
    FROM dbo.route_events re WHERE external_id = N'[seed:district-demo]-2010-M-s4';
...
BEGIN
    INSERT INTO dbo.event_actions (route_event_id, action_type, is_final, charge_amount, charge_quantity, payment_status, notes, billed_statement_number, created_by, date_created)
    SELECT id, N'charge', 0, 60.0000, 1.00, N'PAID', N'Overage charge applied to account.', N'[seed:district-demo]-history', N'Kyle.Patrick', DATEADD(hour, 3, DATEADD(day, -14, GETUTCDATE())) FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-M-s4';
    INSERT INTO dbo.event_actions (route_event_id, action_type, is_final, charge_amount, charge_quantity, payment_status, notes, billed_statement_number, created_by, date_created)
    SELECT id, N'charge', 0, 60.0000, 1.00, NULL,     N'Overage charge applied to account.', N'[seed:district-demo]-history', N'Kyle.Patrick', DATEADD(hour, 3, DATEADD(day, -49, GETUTCDATE())) FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-M-s4';
    INSERT INTO dbo.event_actions (route_event_id, action_type, is_final, charge_amount, charge_quantity, payment_status, notes, billed_statement_number, created_by, date_created)
    SELECT id, N'charge', 0, 60.0000, 1.00, N'PAID', N'Overage charge applied to account.', N'[seed:district-demo]-history', N'Kyle.Patrick', DATEADD(hour, 3, DATEADD(day, -83, GETUTCDATE())) FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-M-s4';
END
GO
...
IF NOT EXISTS (
    SELECT 1 FROM dbo.event_actions ea
    INNER JOIN dbo.route_events re ON ea.route_event_id = re.id
    WHERE re.external_id = N'[seed:district-demo]-2010-s5'
      AND ea.action_type = N'note'
)
    INSERT INTO dbo.event_actions (route_event_id, action_type, is_final, notes, billed_statement_number, created_by, date_created)
    ...
    FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-s5';
...
IF NOT EXISTS (
    SELECT 1 FROM dbo.event_actions ea
    INNER JOIN dbo.route_events re ON ea.route_event_id = re.id
    WHERE re.external_id = N'[seed:district-demo]-2010-M-s5'
      AND ea.action_type = N'note'
)
    INSERT INTO dbo.event_actions (route_event_id, action_type, is_final, notes, billed_statement_number, created_by, date_created)
    SELECT id, N'note', 0, N'First contamination event for this account; courtesy close.',
           N'[seed:district-demo]', N'Kyle.Patrick', DATEADD(minute, -4290, GETUTCDATE())
    FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-M-s5';
...
IF NOT EXISTS (
    SELECT 1 FROM dbo.event_actions ea
    INNER JOIN dbo.route_events re ON ea.route_event_id = re.id
    WHERE re.external_id = N'[seed:district-demo]-2010-s8'
      AND ea.action_type = N'note'
)
    INSERT INTO dbo.event_actions (route_event_id, action_type, is_final, notes, billed_statement_number, created_by, date_created)
    ...
    FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-s8';
...
IF NOT EXISTS (
    ...
    FROM dbo.route_events re WHERE external_id = N'[seed:district-demo]-2010-s8';
...
BEGIN
    INSERT INTO dbo.event_actions (route_event_id, action_type, is_final, charge_amount, charge_quantity, payment_status, notes, billed_statement_number, created_by, date_created)
    SELECT id, N'charge', 0, 70.0000, 1.00, N'PAID',     N'Overage charge applied to account.', N'[seed:district-demo]-history', N'Kyle.Patrick', DATEADD(hour, 3, DATEADD(day, -22, GETUTCDATE())) FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-s8';
    INSERT INTO dbo.event_actions (route_event_id, action_type, is_final, charge_amount, charge_quantity, payment_status, notes, billed_statement_number, created_by, date_created)
    SELECT id, N'charge', 0, 70.0000, 1.00, N'REFUNDED', N'Overage charge applied to account.', N'[seed:district-demo]-history', N'Kyle.Patrick', DATEADD(hour, 3, DATEADD(day, -51, GETUTCDATE())) FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-s8';
    INSERT INTO dbo.event_actions (route_event_id, action_type, is_final, charge_amount, charge_quantity, payment_status, notes, billed_statement_number, created_by, date_created)
    SELECT id, N'charge', 0, 70.0000, 1.00, N'PAID',     N'Overage charge applied to account.', N'[seed:district-demo]-history', N'Kyle.Patrick', DATEADD(hour, 3, DATEADD(day, -88, GETUTCDATE())) FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-s8';
END
...
IF NOT EXISTS (
    SELECT 1 FROM dbo.event_actions ea
    INNER JOIN dbo.route_events re ON ea.route_event_id = re.id
    WHERE re.external_id = N'[seed:district-demo]-2010-M-s8'
      AND ea.action_type = N'note'
)
    INSERT INTO dbo.event_actions (route_event_id, action_type, is_final, notes, billed_statement_number, created_by, date_created)
    SELECT id, N'note', 0, N'Recurring extra volume; recommended service level review.',
           N'[seed:district-demo]', N'Kyle.Patrick', DATEADD(minute, -35, GETUTCDATE())
    FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-M-s8';
...
IF NOT EXISTS (
    ...
    SELECT re.id, N'charge', 1,
           ...
           70.0000, 1.00, N'PAID', N'Overage charge applied to account.',
           N'[seed:district-demo]', N'Kyle.Patrick', DATEADD(minute, -10, GETUTCDATE())
    FROM dbo.route_events re WHERE external_id = N'[seed:district-demo]-2010-M-s8';
...
BEGIN
    INSERT INTO dbo.event_actions (route_event_id, action_type, is_final, charge_amount, charge_quantity, payment_status, notes, billed_statement_number, created_by, date_created)
    SELECT id, N'charge', 0, 70.0000, 1.00, N'PAID',     N'Overage charge applied to account.', N'[seed:district-demo]-history', N'Kyle.Patrick', DATEADD(hour, 3, DATEADD(day, -22, GETUTCDATE())) FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-M-s8';
    INSERT INTO dbo.event_actions (route_event_id, action_type, is_final, charge_amount, charge_quantity, payment_status, notes, billed_statement_number, created_by, date_created)
    SELECT id, N'charge', 0, 70.0000, 1.00, N'REFUNDED', N'Overage charge applied to account.', N'[seed:district-demo]-history', N'Kyle.Patrick', DATEADD(hour, 3, DATEADD(day, -51, GETUTCDATE())) FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-M-s8';
    INSERT INTO dbo.event_actions (route_event_id, action_type, is_final, charge_amount, charge_quantity, payment_status, notes, billed_statement_number, created_by, date_created)
    SELECT id, N'charge', 0, 70.0000, 1.00, N'PAID',     N'Overage charge applied to account.', N'[seed:district-demo]-history', N'Kyle.Patrick', DATEADD(hour, 3, DATEADD(day, -88, GETUTCDATE())) FROM dbo.route_events WHERE external_id = N'[seed:district-demo]-2010-M-s8';
END
GO
