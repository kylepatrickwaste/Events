...
export const ListEventsResponseItem = zod.object({
  ...
  "stop": zod.string().nullish(),
  "workOrderNumber": zod.string().nullish(),
  "tabletNotes": zod.string().nullish(),
  "chargedAmount": zod.coerce.number().nullish().describe('Total charged on this event'),
  "prevChargeCount": zod.coerce.number().int().describe('Number of prior charges on the account (before this event)'),
  "prevChargeTotal": zod.coerce.number().describe('Total amount of prior charges on the account (before this event)'),
